...
class EntityFactory:
    ...
    def get_entity(entity_name: str, position=(0,0)):
        match entity_name:
            ...
            case 'enemy1':
                return Enemy('enemy1', (WINDOW_WIDTH, random.randint(20, WINDOW_HEIGHT-20)))

            case 'enemy2':
                return Enemy('enemy2', (WINDOW_WIDTH, random.randint(20, WINDOW_HEIGHT-20)))

            case 'enemy3':
                return Enemy('enemy3', (WINDOW_WIDTH, random.randint(20, WINDOW_HEIGHT - 20)))
